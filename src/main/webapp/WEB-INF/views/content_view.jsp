						...
						<table class="table">
							...
							<tr>
								...
								<td><input type="text" name="title"
									value="${content.title }" readonly /></td>
							</tr>
							
							<tr>
								<td class="left">작성자</td>
								<td><input type="text" name="name"
									value="${content.writer }" readonly /></td>
							</tr>
							
							<tr>
								<td class="left">내용</td>
								<td><textarea name="content" cols="50" rows="5" readonly>${content.content }
			</textarea></td>
							</tr>
							<tr>
								<td colspan="2"><input type="submit" value="수정"
									class="btn01" />&nbsp;&nbsp; <input type="button" value="삭제"
									onclick="javascript:btn()" class="btn01" />&nbsp;&nbsp; <a
									href="gb"><input type="button" value="목록" class="btn01" /></a>&nbsp;&nbsp;
								</td>
							</tr>
						</table>
					</form>
