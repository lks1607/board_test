...
+".GMFootLeft,.GMFootMid,.GMFootRight {border-top:1px solid #ff981e;}"
...
+""
+"/*sum*/"
+".GMSumCell{background:#f0ede6; color:#FF6407; text-shadow:0 0 1px rgba(0,0,0,0.2);}/*//text-align: right;font-weight:bold;*/"
