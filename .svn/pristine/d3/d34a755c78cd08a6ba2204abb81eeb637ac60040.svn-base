            ...
            <section class="content">
                ...
                <div class="tit-area">
                    ...
                    <ul class="location-area">
                        ...
                        <li><span>인사조직</span></li>
                        <li><span>인사운영</span></li>
                        <li><span>조직관리</span></li>
                        <li><strong>조직관리</strong></li>
                    </ul>
                </div>
                ...
                <table class="tbl-style01">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>사번/성명</th>
                            <td>
                                <input type="text"> / <input type="text"> <span class="ico-user mr15"></span>
                                <a href="#none" class="btn01 st2">조회</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
